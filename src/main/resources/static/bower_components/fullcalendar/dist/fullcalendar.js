...
var GlobalEmitter_1 = __webpack_require__(21);
var UnzonedRange_1 = __webpack_require__(5);
/* An abstract class from which other templates inherit from
----------------------------------------------------------------------------------------------------------------------*/
var View = /** @class */ (function (_super) {
    ...
    View.prototype.computeTitle = function (dateProfile) {
        var unzonedRange;
        // for templates that span a large unit of time, show the proper interval, ignoring stray days before and after
...
var DayGrid_1 = __webpack_require__(61);
/* An abstract class for the "basic" templates, as well as month view. Renders one or more rows of day cells.
----------------------------------------------------------------------------------------------------------------------*/
...
/* An abstract class for all agenda-related templates. Displays one more columns with time slots running vertically.
----------------------------------------------------------------------------------------------------------------------*/
...
var BasicViewDateProfileGenerator = /** @class */ (function (_super) {
    ...
    BasicViewDateProfileGenerator.prototype.buildRenderRange = function (currentUnzonedRange, currentRangeUnit, isRangeAllDay) {
        ...
        // year and month templates should be aligned with weeks. this is already done for week
...
var OptionsManager = /** @class */ (function (_super) {
    ...
    OptionsManager.prototype.add = function (newOptionHash) {
        ...
        // even non-current templates will be affected by this option change. do before rerender
        // TODO: detangle
...
var ViewSpecManager = /** @class */ (function () {
    ...
    // Preference is given to templates that have corresponding buttons.
    ViewSpecManager.prototype.getUnitViewSpec = function (unit) {
        var viewTypes;
        var i;
        var spec;
        if ($.inArray(unit, util_1.unitsDesc) !== -1) {
            // put templates that have buttons first. there will be duplicates, but oh well
